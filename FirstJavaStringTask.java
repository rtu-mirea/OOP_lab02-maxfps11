class TaskFirst {
    private String text = "Журавли живут возле болот, лесных озер, на лугах, берегах речек." +
            "\nГнеда строят прямо на земле! Журавель кружит над гнездом, охраняет его?" +
    ...
    void subTaskFourth() {
        ...
        for (int i = 0; i < this.text.length(); ++i) {
            ...
            if (array[i] == '!' ||
                    array[i] == '?' ||
                    array[i] == '.') {
                System.out.print(" Колличество слов в предложении = " + wordCounter);
                wordCounter = 1;
            }
        }
